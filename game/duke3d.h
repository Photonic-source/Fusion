...
extern int connecthead, connectpoint2[MAXMULTIPLAYERS];   //Player linked list variables (indeces, not connection numbers)
...
extern int g_networkConnectMode;
