...
void M_DisplayMenus(void)
{
        ...
        c = (320>>1)-120;
        {
            ...
            if (g_currentMenu == 20002)
            {
                ...
                for (ii=io=0; opts[ii]; ii++)
                {
                    ...
                    case 7:
                        // if (x == io)
                        //     packetrate = min(max(((packetrate)+20,20),120);
                        // modval(20,120,(int *)&packetrate,10,probey==7?2:0);
                        break;
                    case 8:
                        if (x == io)
                        {
            ...
            yy = 37;
            {
                for (ii=io=0; opts[ii]; ii++)
                {
                    ...
                    case 7:
                        ...
                        mgametext(d+75,yy,tempbuf,MENUHIGHLIGHT(io),2+8+16);
						Bsprintf(tempbuf," :  %d",g_movesPerPacket);
                        mgametext(d+90,yy,tempbuf,MENUHIGHLIGHT(io),2+8+16);
                        break;
    ...
    case 998:
        ...
        if (!VOLUMEALL || !PLUTOPAK)
        {
            ...
            menutext(c,24,0,0,g_currentMenu == 998 ? "ABOUT" : "CREDITS");
